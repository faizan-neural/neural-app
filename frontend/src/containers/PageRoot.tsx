...
const MENU_ITEMS: MenuProps['items'] = [
    ...
    {
        key: 'ai-ml',
        label: localize('menu_item.ai_ml', 'AI/ML'),
        icon: <img alt="ai/ml" src="/icons/aiml.png" style={{height: 20,width:20}}/>,
    },
    {
        key: 'monitoring',
                ...
                >
                    <div>
                        <Row>
                            ...
                            {// good condition to use this.props.isMobile &&
                            ...
                            {!self.props.isMobile && (
                                <Col span={12}>
                                    <Row justify="end" align='middle'>
                                        {/*
                                        kept here as examples, can delete as needed
                ...
                <Layout>
                    ...
                    <Content>
                        ...
                        >
                            ...
                            <Row style={{width: '100%', justifyContent: 'space-between', padding: '0 2rem', marginTop:'3rem'}} >
                                <p>© 2023 - 2024, Neural Technology Services. All Rights Reserved.</p>
                                <Row style={{width:'25%', justifyContent: 'space-between'}}>
                                    <a style={{color:'#000000'}}>Terms of Use</a>
                                    <a style={{color:'#000000'}}>Privacy Policy</a>
                                    <img alt="ai/ml" src="/icons/chat-outline.png" style={{height: 30, marginLeft:25}}/>
                                </Row>
                            </Row>
                        </div>
                    </Content>
