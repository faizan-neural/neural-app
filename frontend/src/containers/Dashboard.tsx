...
> {
    ...
    loadAppIcons(){
        const appIcons = [
            {image:'/apps/app 0.png'},
            {image:'/apps/app 1.png'},
            {image:'/apps/app 2.png'},
            {image:'/apps/app 3.png'},
            {image:'/apps/app 4.png'},
            {image:'/apps/app 5.png'},
            {image:'/apps/app 6.png'},
            {image:'/apps/app 7.png'},
        ];

        return appIcons.map((icon) =>{
            return(<div className='app-image-small'><img src={icon['image']} /></div>)
        })
    }
    ...
    loadNotifications(){
        const apiIcons = [
            {image:'/icons/docker.png', alt:'docker', text:'Lorem Ipsum dolar sit amet'},
            {image:'/icons/kubernete.png', alt:'kubernete', text:'Lorem Ipsum dolar sit amet'},
            {image:'/icons/docker.png', alt:'docker', text:'Lorem Ipsum dolar sit amet'},
            {image:'/icons/kubernete.png', alt:'kubernete', text:'Lorem Ipsum dolar sit amet'},
            {image:'/icons/docker.png', alt:'docker', text:'Lorem Ipsum dolar sit amet'},
        ];

        return apiIcons.map((notification) =>{
            return(
    ...
    render() {
        ...
        return (
            <div>
                <h1 style={{margin:'2rem 2.5rem'}}>Dashboard</h1>
    ...
    createInitialSetupIfNoRootSsl() {
        ...
        return (
            <>
                    ...
                    <Col xs={{ span: 23 }} lg={{ span: 16 }}>
                        <Card title="Getting Started">
                            <div>
                                ...
                                <p>
                                    Welcome to Neural Technology Services Platform! You can now deploy your apps! Remember, with NTS tech, you can deploy applications from source code (such as Node.js, PHP, Java, Ruby, Python, etc) and you can also deploy ready to go applications such as MYSQL, MongoDB, Neural AI & ML applications, APIs, models, training, data, and labeling services!
                                </p>
                                <p>
                                    For more information on how to deploy applications from source code, make sure to have a look at our sample apps
                                </p>
                                <p>
                                    <em>
                                        You can always update your root domain, but be careful! your SSL certificates will get revoked because of the domain change.
                                    </em>
                                </p>
                                <Button
                                    ...
                                    */}}
                                    style={{marginLeft:'70%', marginTop:'1rem'}}
                                >
                ...
                <Row justify="space-around" style={{marginTop:'2.5rem', marginBottom:'3rem'}}>
                    <Col xs={{ span: 23 }} lg={{ span: 7 }}>
                        <a className='view-all-link'>view all</a>
                        <Card title="Apps" style={{paddingBottom: '1.3rem'}}>
                    ...
                    <Col xs={{ span: 23 }} lg={{ span: 7 }}>
                        <a className='view-all-link'>view all</a>
                        <Card title="APIs" style={{paddingBottom: '1.3rem'}}>
                            <div style={{display:'flex', flexWrap: 'wrap', justifyContent: 'space-between'}} >
                                {this.loadApiIcons()}
                            </div>
                        </Card>
                    ...
                    <Col xs={{ span: 23 }} lg={{ span: 6 }}>
                        ...
                        <Card title="What's New">
                            <div>
                                <Row style={{marginTop:2, width:'100%'}} justify="space-between">
                                    <p style={{width:'80%'}}>Lorem Ipsum dolar sit amet Lorem Ipsum dolar sit amet</p>
                                    <img
                                        alt="export"
                                        src="/icons/export-icon.png"
                                        style={{
                                            height: 20,
                                            width:20,
                                            marginRight: 20,
