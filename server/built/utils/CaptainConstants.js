...
const CAPTAIN_BASE_DIRECTORY = EnvVars_1.default.CAPTAIN_BASE_DIRECTORY || '/captain';
...
const data = {
    ...
    // ******************** Global Constants *********************
    apiVersion: 'v2',
    isDebug: EnvVars_1.default.CAPTAIN_IS_DEBUG,
    ...
    // *********************     ETC       ************************
    disableFirewallCommand: 'ufw allow 80,443,3000,996,7946,4789,2377/tcp; ufw allow 7946,4789,2377/udp; ',
    gitShaEnvVarKey: 'CAPROVER_GIT_COMMIT_SHA',
};
function overrideConfigFromFile(fileName) {
